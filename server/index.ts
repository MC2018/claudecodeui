...
// Claude subscription usage limits (5h / weekly / per-model) for the composer widget
...
async function startServer() {
    try {
        ...
        server.listen(SERVER_PORT, HOST, async () => {
            ...
            // Mirror archive/delete/title state from the Claude desktop app's
            // own session store (it never deletes transcript files itself)
