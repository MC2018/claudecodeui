      ...
      {!hasQuestionPanel && <div className="relative mx-auto max-w-[54.25rem]">
        ...
        <PromptInputFooter>
          ...
          <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
            {/* The keyboard hint is hidden in this fork. The composer is capped
                at ~54rem, and once the usage-limits widget is in the tool row
                the hint cannot fit at any viewport width — showing it either
                overlapped the token counter or forced it to be clipped. The
                shortcuts it described are discoverable in Settings. */}
